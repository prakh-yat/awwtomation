/**
 * ISO 3166-1 alpha-2 countries accepted by Dodo (mirrors the SDK's CountryCode
 * union). Generated from node_modules/dodopayments/resources/misc.d.ts + Intl
 * display names; regenerate if the SDK adds regions.
 */

export type Country = { code: string; name: string };

/** Shown first in the picker: home market plus the most common billing countries. */
export const FEATURED_COUNTRY_CODES: readonly string[] = ["NP","US","GB","AU","CA","IN","DE","FR","SG","AE"];
...
export const FEATURED_COUNTRIES: readonly Country[] = FEATURED_COUNTRY_CODES.map((code) => byCode.get(code)).filter(
  (c): c is Country => c !== undefined,
);

export const OTHER_COUNTRIES: readonly Country[] = COUNTRIES.filter((c) => !FEATURED_COUNTRY_CODES.includes(c.code));
