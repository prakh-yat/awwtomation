  ...
  return (
    <div className="flex gap-2.5">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 text-[13px] leading-[1.45] text-ink">{children}</p>
  ...
  return (
    <Panel className={cn("flex flex-col", className)}>
      <div className="flex items-center gap-2.5 border-b px-3.5 py-3">
        <ChevronLeft aria-hidden className="size-4 text-ink/60" strokeWidth={2} />
      ...
      <div className="space-y-3 px-3.5 pb-4 pt-3">
        ...
        <div className="flex items-end gap-2">
          ...
          <div className="min-w-0 max-w-[86%]">
            ...
            <div className="overflow-hidden rounded-[18px] rounded-bl-md border bg-background">
              ...
              <p className="flex items-center justify-center gap-1.5 border-t px-3 py-2 text-[13px] font-semibold">
                Shop the collection
        ...
        <div className="flex flex-col items-end gap-1 pt-1">
          <p className="max-w-[80%] rounded-[18px] rounded-br-md bg-ink px-3.5 py-2 text-[13px] leading-[1.45] text-white">
 ...
 * on the right, tilted a little apart like the site's stacked cards. Built
 * from divs so it stays sharp and matches the product.
 */
function HeroVisual({ className }: { className?: string }) {
  return (
    ...
    >
      <CommentsPanel className="sm:-rotate-2" />
      <DirectMessagePanel className="sm:-translate-y-4 sm:rotate-[1.5deg]" />
    </div>
  );
}
